var SpawnFunction = {  
    run: function(target) {  
        ...
        var sourceRooms = ['E54N19','E54N18','E55N18','E55N17','E53N19']; 
        ...
        // 然后检查房间能量和任务列表  
        if (spawnRoom.energyAvailable < 2800 && !roomMemory.tasks.some(task => task.type === 'fillExtension')) {  
            // 推送 'fillExtension' 任务  
        ...
        var roleConfigs = [  
            ...
            { role: 'repairer',         sourceRoom: sourceRooms[4], targetRoom: targetRooms[0], workLoc: [0],     maxNumber: 0, priority: 6},
            ...
            { role: 'claimer',          sourceRoom: sourceRooms[4], targetRoom: targetRooms[0], workLoc: [0],     maxNumber: 0, priority: 5},    
            ...
            { role: 'Newbuilder',       sourceRoom: sourceRooms[4], targetRoom: targetRooms[0], workLoc: [0],     maxNumber: 0, priority: 2}, 
...
function createCreepBody(role) {    //返回body
    ...
    switch (role) {  
        case 'harvester':  
            body = [WORK,WORK,WORK,WORK,WORK,WORK,WORK,WORK,WORK,WORK,WORK,WORK,CARRY,CARRY,CARRY,CARRY,CARRY,CARRY,MOVE,MOVE,MOVE,MOVE,MOVE,MOVE,MOVE,MOVE,MOVE];  
            break;  
        case 'harvester 2':  
            body = [WORK,WORK,WORK,WORK,WORK,WORK,WORK,WORK,WORK,WORK,WORK,WORK,MOVE,MOVE,MOVE,MOVE,MOVE,MOVE,MOVE,MOVE,MOVE]; 
                break; 
        case 'transferer':  
        ...
        case 'manager':  
            ...
            break;  
        case 'upgrader':  
            body = [WORK,WORK,WORK,WORK,WORK,WORK,WORK,WORK,WORK,WORK,WORK,WORK,WORK,WORK,WORK,WORK,WORK,CARRY,CARRY,CARRY,CARRY,CARRY,CARRY,CARRY,CARRY,CARRY,CARRY,MOVE,MOVE,MOVE,MOVE,MOVE,MOVE,MOVE,MOVE,MOVE,MOVE,MOVE,MOVE,MOVE,MOVE,MOVE,MOVE,MOVE,MOVE];  
            break;  
        case 'builder':  
            body = [WORK,WORK,WORK,WORK,WORK,WORK,WORK,WORK,WORK,WORK,WORK,WORK,CARRY,CARRY,CARRY,CARRY,CARRY,CARRY,MOVE,MOVE,MOVE,MOVE,MOVE,MOVE,MOVE,MOVE,MOVE];  
            break;  
        ...
        case 'Centraltransferer':  
            body = [CARRY,CARRY,CARRY,CARRY,CARRY,CARRY,CARRY,CARRY,CARRY,CARRY,CARRY,CARRY,CARRY,CARRY,CARRY,CARRY,CARRY,CARRY,CARRY,CARRY,CARRY,CARRY,CARRY,CARRY,CARRY,CARRY,MOVE];  
            break;  
        ...
        case 'claimer':  
            ...
            break;  
        case 'NewHarvester':  
            body = [WORK,WORK,WORK,WORK,WORK,WORK,WORK,CARRY,CARRY,CARRY,CARRY,CARRY,CARRY,CARRY,CARRY,CARRY,CARRY,CARRY,CARRY,CARRY,CARRY,CARRY,MOVE,MOVE,MOVE,MOVE,MOVE,MOVE,MOVE,MOVE,MOVE,MOVE,MOVE];  
            break;  
        case 'Newbuilder':  
            body = [WORK,WORK,WORK,WORK,WORK,WORK,WORK,WORK,WORK,WORK,CARRY,MOVE,CARRY,MOVE,CARRY,MOVE,CARRY,MOVE,MOVE,MOVE,MOVE,MOVE,MOVE,MOVE,MOVE,MOVE];  
            break;  
        case 'repairer':  
            body = [WORK,WORK,WORK,WORK,WORK,WORK,WORK,WORK,WORK,WORK,WORK,WORK,WORK,WORK,WORK,WORK,WORK,WORK,WORK,WORK,WORK,WORK,WORK,WORK,WORK,MOVE,MOVE,MOVE,MOVE,MOVE,MOVE,MOVE,MOVE,MOVE,MOVE,MOVE,MOVE,MOVE,MOVE,MOVE,MOVE,MOVE,MOVE,MOVE,MOVE,MOVE,MOVE,MOVE,MOVE,MOVE];  
            break;  
        default:  
            body = [TOUGH]; 
    }  
